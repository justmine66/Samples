using Aop.demo.AspnetCore.CrossCuttings;
using Aop.demo.AspnetCore.Domain;
using Aop.demo.AspnetCore.Extensions;
...
namespace Aop.demo.AspnetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc().SetCompatibilityVersion(CompatibilityVersion.Version_2_2).AddSb();
