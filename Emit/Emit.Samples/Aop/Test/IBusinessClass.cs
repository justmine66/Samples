...
namespace Emit.Samples.Aop.Test
{
    ...
    {
        public static IBusinessClass Instance = DynamicProxy.CreateProxy<IBusinessClass, BusinessClass>();
    ...
    {
        public static IBusinessClass Instance = DynamicProxy.CreateProxy<BusinessClassInherit>();
